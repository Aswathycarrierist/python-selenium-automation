...
class Page:
    ...
    def wait_for_element_to_appear(self,*locator):
        self.wait.unitl(EC.visibility_of_element_located(locator),
        message = f'element by {locator} did not appear')



    def wait_for_element_to_disappear(self, *locator):
        self.wait.unitl(EC.invisibility_of_element_located(locator),
    ...
    def verify_url(self,expected_url):
        ...
        assert current_url == expected_url,f'Expected {expected_url} but got actual {current_url}'
    ...
    def switch_to_new_window(self):
        ...
        print(f'switching to new window {all_windows[1]}')
    ...
    def switch_window_by_id(self,window_id):
        print(f'switching to new window {window_id}')
